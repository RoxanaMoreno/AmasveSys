...
<div class="container mt-4">
    ...
    <?php else : ?>
        <form id="editVoluntarioForm" action="edit_voluntario.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="telefono" name="telefono" value="<?php echo htmlspecialchars($voluntario['telefono']); ?>" pattern="\d{9}" title="Debe contener 9 dígitos" required>
            </div>
            <div class="mb-3">
